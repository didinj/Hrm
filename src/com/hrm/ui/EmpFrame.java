...
public class EmpFrame extends javax.swing.JInternalFrame {
    ...
    public EmpFrame() {
        ...
        if (!Beans.isDesignTime()) {
            ...
            deptCombo.setSelectedItem("OPERASIONAL");
        }
    ...
    private void initComponents() {
        ...
        deptList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : deptQuery.getResultList();
